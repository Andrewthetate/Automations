    ...
    <section id="services" className="container mx-auto px-6 py-24">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service, index) => (
          <Card
            key={index}
            className="group hover-lift hover-glow bg-white/5 border-white/10 hover:border-[#D4AF37]/50 hover:shadow-lg hover:shadow-[#D4AF37]/20 transition-all duration-300 backdrop-blur-sm p-6"
          >
    ...
    <section id="tech" className="container mx-auto px-6 py-24">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {technologies.map((tech, index) => (
          <Card
            key={index}
            className="hover-lift hover-glow bg-white/5 border-white/10 hover:border-[#D4AF37]/50 hover:scale-105 transition-all duration-300 p-6 text-center group"
          >
